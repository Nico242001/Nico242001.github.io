...
function cards(){
    ...
    for (let i = 0; i <20 ; i++){
        document.getElementById("itemContainer").innerHTML += "<div class='p-2 col-xxl-3 col-xl-4 col-lg-5 col-md-6 col-sm-7 col-xs-12'><div class='card' style='width:200px'><img class='card-img-top' src='placeHolder.jpg' alt='Card image'><div class='card-body'><h4 class='card-title'>John Doe</h4><p class='card-text'>Some example text.</p><a href='#' class='btn btn-primary'>See Profile</a></div></div></div>"
    }
